...
echo
    ...
    '<p>'.form::hidden(array('relatedEntries_filters_config'), 'relatedEntries').
    '<input type="hidden" name="p" value="relatedEntries" />'.
    form::hidden(array('id'), $id).
    form::hidden(array('tab'), 'postslist').
    '</p>'.
    '</form>';
