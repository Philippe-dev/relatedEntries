...
$(() => {
    ...
    $filtersform.before(
        `<p><a id="filter-control" class="form-control" href="plugin.php?p=relatedEntries&relatedEntries_filters=relatedEntries&id=${id}" style="display:inline">${dotclear.msg.filter_posts_list}</a></p>`
    );
